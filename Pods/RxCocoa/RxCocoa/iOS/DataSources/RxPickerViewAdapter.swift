...
final class RxPickerViewAdapter<Sequence: Swift.Sequence>: RxPickerViewSequenceDataSource<Sequence>, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing viewShowDetail: UIView?) -> UIView {
        return viewForRow(row, items[row], viewShowDetail)
    }
}
